...
describe('Service Tests', () => {
    ...
    describe('Downloads Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DownloadsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/downloads';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Downloads', () => {

                let entity: Downloads;
                service.find(123).subscribe((_entity: Downloads) => {
                    entity = _entity;
                });
