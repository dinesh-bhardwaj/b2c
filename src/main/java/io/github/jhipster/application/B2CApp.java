...
public class B2CApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(B2CApp.class);

    private final Environment env;

    public B2CApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(B2CApp.class);
